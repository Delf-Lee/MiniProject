...
public class MainApp extends JFrame {
	public JPanel mainPanel = new JPanel(); // ¸ÞÀÎÆÐ³Î
	...
	public void setLoginPanel() {
		...
		loginPanel.setBounds(262, 350, 500, 300); // ÁÂÇ¥/Å©±â
		loginPanel.setBackground(Color.CYAN);
		
		JLabel j1 = new JLabel("ID");
		j1.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 30));
		j1.setBounds(60, 40, 100, 100);
		
		JTextField id = new JTextField();
		id.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 20));
		id.setBounds(130, 75, 270, 40);
				
		JLabel j2 = new JLabel("PW");
		j2.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 30));
		j2.setBounds(50, 90, 100, 100);
		
		JPasswordField pw = new JPasswordField();
		pw.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 20));
		...
		signup.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 20));
	...
	public void setSignupPanel() {
		...
		signupPanel.setBounds(262, 350, 500, 300); // ÁÂÇ¥/Å©±â
		...
		JLabel j3 = new JLabel("PWÈ®ÀÎ");
		j3.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 30));
		j3.setBounds(40, 120, 150, 100);
		
		JPasswordField checkPw = new JPasswordField();
		checkPw.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 20));
